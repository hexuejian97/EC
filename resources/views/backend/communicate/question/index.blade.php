    ...
    <div class="box box-success">
        <div class="box-header with-border">
            ...
            <div class="box-tools pull-right">
                <a href="{{route('admin.question.add')}}" class="btn btn-success btn-xs">新建问题</a>
        ...
        <div class="box-body">
            <div class="table-responsive" >
                ...
                <table  id="table"  data-toggle="table" data-url="{{route('admin.question.data')}}" data-toolbar="#toolbar"
                    ...
                    <tr>
                        ...
                        <th data-field="question"  data-align="center">问题</th>
...
@section('after-scripts')
    ...
    <script>
        ...
        function actionFormatter(value, row, index) {
            var del = '<a href="{{url('admin/question/update')}}/'+row.id+'" class="btn btn-xs btn-primary update"> ' +
