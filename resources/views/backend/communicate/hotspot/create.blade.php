...
@section('content')
    {{ Form::open(['route' => 'admin.hotspot.create', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post']) }}

    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">新建热点</h3>
        ...
        <div class="box-body">
            <div class="form-group">
                ...
                <div class="col-lg-6">
                    {{ Form::text('hot_title', null, ['class' => 'form-control', 'maxlength' => '191', 'required' => 'required', 'autofocus' => 'autofocus', 'placeholder' => '']) }}
                </div><!--col-lg-10-->
            </div><!--form control-->
            <div class="form-group">
                {{ Form::label('last_name', '链接地址',['class' => 'col-lg-2 control-label']) }}
                <div class="col-lg-6">
                    {{ Form::text('hot_link', null, ['class' => 'form-control', 'maxlength' => '191', 'required' => 'required', 'placeholder' => '']) }}

                </div><!--col-lg-10-->
            </div><!--form control-->

            <div class="form-group" style="margin-bottom: 10px;">
                {{ Form::label('goods_pic', '热点图片', ['class' => 'col-lg-2 control-label']) }}
                <div class="col-lg-6">
                    ...
                    {{ Form::text('hot_picture', null, ['id' => 'hot_picture','class' => 'form-control', 'maxlength' => '191', 'required' => 'required', 'placeholder' => '' ,'readonly' => 'readonly']) }}
                </div>
            </div><!--form control-->
        </div><!-- /.box-body -->
    </div><!--box-->
