...
@section('content')
    {{ Form::open(['route' => 'admin.physician.create', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post']) }}
        ...
        <div class="box box-success">
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        {{ Form::text('phy_name', null, ['class' => 'form-control', 'maxlength' => '191', 'required' => 'required', 'autofocus' => 'autofocus', 'placeholder' => '请输入姓名']) }}
                    </div><!--col-lg-10-->
                </div><!--form control-->
                <div class="form-group">
                    {{ Form::label('last_name', '职称',['class' => 'col-lg-2 control-label']) }}
                    <div class="col-lg-6">
                        {{ Form::text('phy_title', null, ['class' => 'form-control', 'maxlength' => '191', 'required' => 'required', 'placeholder' => '请输入职称']) }}
                    </div><!--col-lg-10-->
                </div><!--form control-->
                <div class="form-group" style="margin-bottom: 10px;">
                    ...
                    <div class="col-lg-6">
                        ...
                        {{ Form::text('phy_picture', null, ['id' => 'phy_picture','class' => 'form-control', 'maxlength' => '191', 'required' => 'required', 'placeholder' => '' ,'readonly' => 'readonly']) }}
                    </div>
                </div><!--form control-->
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        {{ Form::textarea('phy_intro', null, ['class' => 'form-control', 'maxlength' => '', 'required' => 'required', 'placeholder' => '请输入简介']) }}
                    </div><!--col-lg-10-->
                </div><!--form control-->
                <!--form control-->
            </div><!-- /.box-body -->
