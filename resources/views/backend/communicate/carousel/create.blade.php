...
@section('content')
    {{ Form::open(['route' => 'admin.carousel.create', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post']) }}

    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">新建轮播</h3>
        ...
        <div class="box-body">
            <div class="form-group">
                ...
                <div class="col-lg-6">
                    {{ Form::text('car_title', null, ['class' => 'form-control', 'maxlength' => '191', 'required' => 'required', 'autofocus' => 'autofocus', 'placeholder' => '']) }}
                </div><!--col-lg-10-->
            </div><!--form control-->
            <div class="form-group">
                {{ Form::label('last_name', '链接地址',['class' => 'col-lg-2 control-label']) }}
                <div class="col-lg-6">
                    {{ Form::text('car_link', null, ['class' => 'form-control', 'maxlength' => '191', 'required' => 'required', 'placeholder' => '']) }}
...
>>>>>>> bde2147ec0d58b153e8ebf721fb0035dd5582f9a
            <div class="form-group" style="margin-bottom: 10px;">
                ...
                <div class="col-lg-6">
                    ...
                    {{ Form::text('car_picture', null, ['id' => 'phy_picture','class' => 'form-control', 'maxlength' => '191', 'required' => 'required', 'placeholder' => '' ,'readonly' => 'readonly']) }}
                </div>
            </div><!--form control-->
        </div><!-- /.box-body -->
    </div><!--box-->
