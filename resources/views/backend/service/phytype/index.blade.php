...
@section('content')
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">医师职称列表</h3>

            <div class="box-tools pull-right">
                <a href="{{route('admin.phy_type.add')}}" class="btn btn-success btn-xs">新建医师职称</a>
        ...
        <div class="box-body">
            <div class="table-responsive" >
                ...
                <table  id="table"  data-toggle="table" data-url="{{route('admin.phy_type.data')}}" data-toolbar="#toolbar"
                    ...
                    <tr>
                        ...
                        <th data-field="pt_name"  data-align="center">医师职称</th>
...
@section('after-scripts')
    ...
    <script>
            ...
            window.actionEvents = {
                'click .remove': function (e, value, row) {
                    swal({
                        ...
                        $.ajax({
                            type: 'post',
                            url: '{{route('admin.phy_type.delete')}}',
                            dataType: 'json',
                            data: {id:row.id},
                            success: function (data) {
                                if (data.code == 2000) {
        ...
        function actionFormatter(value, row, index) {
            var del = '<a href="{{url('admin/phytype/update')}}/'+row.id+'" class="btn btn-xs btn-primary update"> ' +
