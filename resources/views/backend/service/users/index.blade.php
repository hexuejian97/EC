    ...
    <div class="box box-success">
            ...
            <div class="form-inline" role="form">
                <div class="form-group">
                    <select id="area" class="select2" name="name">
                        ...
                        @foreach($data as $k=>$v)
                            <option value="{{$v->user_name}}">{{$v->user_name}}</option>
                        @endforeach
                    </select>
        ...
        <div class="box-body">
            <div class="table-responsive" >
                ...
                <table  id="table"  data-toggle="table" data-url="{{route('admin.users.getdata')}}" data-toolbar="#toolbar"
                    ...
                    <tr>
                        ...
                        <th data-field="user_name"  data-align="center">会员呢称</th>
                        <th data-field="user_phone"  data-align="center">手机号</th>
                        <th data-field="created_at"  data-align="center">注册时间</th>
...
@section('after-scripts')
    ...
    <script>
        ...
        function actionFormatter(value, row, index) {
            ...
            var ddf = '<a href="{{url('admin/users/info')}}/'+row.id+'" class="btn btn-xs btn-primary "> ' +
