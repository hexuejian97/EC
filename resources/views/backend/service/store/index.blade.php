...
@section('content')
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">连锁店列表</h3>

            <div class="box-tools pull-right">
                <a href="{{route('admin.store.add')}}" class="btn btn-success btn-xs">新建门店</a>
        ...
        <div class="box-body">
            <div class="table-responsive" >
                ...
                <table  id="table"  data-toggle="table" data-url="{{route('admin.store.data')}}" data-toolbar="#toolbar"
...
@section('after-scripts')
    ...
    <script>
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                if (data.code == 2000) {
                                    ...
                                    swal("删除失败!", "删除失败,门店下有医师,不可删除.", "warning");
                                }
                            },
                            error: function (data) {
                                $('#table').bootstrapTable('remove', {field: 'id', values: [row.id]});
        ...
        function actionFormatter(value, row, index) {
            var ddf = '<a href="{{url('admin/store/info')}}/'+row.id+'" class="btn btn-xs btn-primary "> ' +
                '<i class="fa fa-pencil " data-toggle="tooltip" data-placement="top" ' +
                'data-toggle="tooltip" data-placement="top" title="查看">查看</i></a>&nbsp;&nbsp;';
            var del = '<a href="{{url('admin/store/update')}}/'+row.id+'" class="btn btn-xs btn-primary update"> ' +
