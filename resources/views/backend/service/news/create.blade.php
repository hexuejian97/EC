...
@section('content')
    {{ Form::open(['route' => 'admin.news.create', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post']) }}

        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">创建新闻资讯</h3>
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        {{ Form::text('news_title', null, ['class' => 'form-control', 'maxlength' => '191', 'required' => 'required', 'autofocus' => 'autofocus', 'placeholder' => '请输入标题']) }}
                    </div><!--col-lg-10-->
                </div><!--form control-->
                <div class="form-group">
