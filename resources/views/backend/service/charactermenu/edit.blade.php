...
@section('content')
    {{ Form::open(['route' => 'admin.characteristic_menu.edit', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post']) }}
    ...
    <div class="box box-success">
        ...
        <div class="box-body">
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    {{ Form::text('name', $menu->name, ['class' => 'form-control', 'maxlength' => '200', 'required' => 'required', 'autofocus' => 'autofocus', 'placeholder' => '请输入标题']) }}
                </div><!--col-lg-10-->
            </div><!--form control-->
        </div><!-- /.box-body -->
    </div><!--box-->
