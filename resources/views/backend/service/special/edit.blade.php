...
@section('content')
    {{ Form::open(['route' => 'admin.special.edit', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post']) }}

    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">特色技术编辑</h3>
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <textarea name="news_content" id="editor"  style="width: 100%;height: 300px" cols="30" rows="10">{!! $special->content !!}</textarea>
                </div><!--col-lg-10-->
            </div><!--form control-->
        </div><!-- /.box-body -->
    </div><!--box-->
