...
@section('content')
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">特色技术</h3>

            <div class="box-tools pull-right">
                <a href="{{route('admin.special.create')}}" class="btn btn-success btn-xs">新增</a>
            </div><!--box-tools pull-right-->
        </div><!-- /.box-header -->
        <div class="box-body">
            <div class="table-responsive" >

                <table  id="table"  data-toggle="table" data-url="{{route('admin.special.getdata')}}" data-toolbar="#toolbar"
...
@section('after-scripts')
    ...
    <script>
            ...
            window.actionEvents = {
                'click .remove': function (e, value, row) {
                    swal({
                        ...
                        $.ajax({
                            type: 'post',
                            url: '{{route('admin.special.delopty')}}',
                            dataType: 'json',
                            data: {id:row.id},
                            success: function (data) {
                                if (data.code == 2000) {
        ...
        function actionFormatter(value, row, index) {
            ...
            var ddf = '<a href="{{url('admin/special/info')}}/'+row.id+'" class="btn btn-xs btn-primary "> ' +
                '<i class="fa fa-pencil " data-toggle="tooltip" data-placement="top" ' +
                'data-toggle="tooltip" data-placement="top" title="查看">查看</i></a>&nbsp;&nbsp;';
            var del = '<a href="{{url('admin/special/update')}}/'+row.id+'" class="btn btn-xs btn-primary update"> ' +
