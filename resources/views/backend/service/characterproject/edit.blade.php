...
@section('content')
    {{ Form::open(['route' => 'admin.characteristic_project.edit', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post']) }}

    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">项目管理编辑</h3>
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    {{ Form::text('title', $project->title, ['class' => 'form-control', 'maxlength' => '200', 'required' => 'required', 'autofocus' => 'autofocus', 'placeholder' => '请输入标题']) }}
                </div><!--col-lg-10-->
            </div><!--form control-->
        </div><!-- /.box-body -->
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
                <textarea name="content" id="editor" cols="30" rows="10">{{$project->content}}</textarea>
            </div><!--col-lg-10-->
        </div><!--fo
    </div><!--box-->
