    ...
    <div class="box box-success">
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-6">
                    <textarea name="educational_bg" id="editor" style="width: 100%;height: 300px;" cols="30" rows="5">{{$phy->educational_bg}}</textarea>
                </div><!--col-lg-10-->
            </div><!--form control-->
            <div class="form-group">
                {{ Form::label('news_content', '临床医疗工作背景',['class' => 'col-lg-2 control-label']) }}
                <div class="col-lg-6">
                    <textarea name="clinical_bg" id="clinical_bg" style="width: 100%;height: 300px;" cols="30" rows="5">{{$phy->educational_bg}}</textarea>
                </div><!--col-lg-10-->
            </div><!--form control-->
            <div class="form-group">
                {{ Form::label('news_content', '专业技能',['class' => 'col-lg-2 control-label']) }}
                <div class="col-lg-6">
                    <textarea name="skills" id="skills" style="width: 100%;height: 300px;" cols="30" rows="5">{{$phy->skills}}</textarea>
                </div><!--col-lg-10-->
            </div><!--form control-->
            <div class="form-group">
                {{ Form::label('news_content', '科研情况及发表文章情况',['class' => 'col-lg-2 control-label']) }}
                <div class="col-lg-6">
                    <textarea name="research"  id="research" style="width: 100%;height: 300px;" cols="30" rows="5">{{$phy->research}}</textarea>
                </div><!--col-lg-10-->
            </div><!--form control-->
            <div class="form-group">
                {{ Form::label('news_content', '参与科研项目及培训',['class' => 'col-lg-2 control-label']) }}
                <div class="col-lg-6">
                    <textarea name="research_project" id="research_project" style="width: 100%;height: 300px;" cols="30" rows="5">{{$phy->research_project}}</textarea>
                </div><!--col-lg-10-->
            </div><!--form control-->
            <div class="form-group">
                {{ Form::label('news_content', '参与全国学术会议情况',['class' => 'col-lg-2 control-label']) }}
                <div class="col-lg-6">
                    <textarea name="learning" id="learning" style="width: 100%;height: 300px;" cols="30" rows="5">{{$phy->learning}}</textarea>
                </div><!--col-lg-10-->
            </div><!--form control-->
            <div class="form-group">
                {{ Form::label('news_content', '奖励与荣誉',['class' => 'col-lg-2 control-label']) }}
                <div class="col-lg-6">
                    <textarea name="honor" id="honor" cols="30" style="width: 100%;height: 300px;" rows="5">{{$phy->honor}}</textarea>
                </div><!--col-lg-10-->
            </div><!--form control-->
