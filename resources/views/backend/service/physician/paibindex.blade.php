    ...
    <div class="box box-success">
        <div class="box-header with-border">
            ...
            <div class="box-tools pull-right">
                <a href="" class="btn btn-success btn-xs">新建排班</a>
        ...
        <div class="box-body">
            <div class="table-responsive" >
                ...
                <table  id="table"  data-toggle="table" data-url="{{route('admin.paib.paibdata')}}" data-toolbar="#toolbar"
    ...
    <script>
        $(function() {
            ...
            window.actionEvents = {
                ...
                'click .paib' : function(e, value, row){
                    window.location.href='{{url('admin/paib/index')}}';
                }
        ...
        function actionFormatter(value, row, index) {
            ...
            var ddf = '<a href="{{url('admin/physician/info')}}/'+row.id+'" class="btn btn-xs btn-primary "> ' +
                ...
                'data-toggle="tooltip" data-placement="top" title="查看排班">查看排班   </i></a>&nbsp;&nbsp;';
            var del = '<a href="{{url('admin/paib/create')}}/'+row.id+'" class="btn btn-xs btn-primary update"> ' +
