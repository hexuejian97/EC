    ...
    <div class="box box-success">
        ...
        <div class="box-body">
            <div class="table-responsive" >
                ...
                <table  id="table"  data-toggle="table" data-url="{{route('admin.optometry.getdata')}}" data-toolbar="#toolbar"
...
@section('after-scripts')
    ...
    <script>
            ...
            window.actionEvents = {
                'click .remove': function (e, value, row) {
                    swal({
                        ...
                        $.ajax({
                            type: 'post',
                            url: '{{route('admin.optometry.delopty')}}',
                            dataType: 'json',
                            data: {id:row.id},
                            success: function (data) {
                                if (data.code == 2000) {
        ...
        function actionFormatter(value, row, index) {
            ...
            var ddf = '<a href="{{url('admin/optometry/info')}}/'+row.id+'" class="btn btn-xs btn-primary "> ' +
                '<i class="fa fa-pencil " data-toggle="tooltip" data-placement="top" ' +
                'data-toggle="tooltip" data-placement="top" title="查看">查看</i></a>&nbsp;&nbsp;';
            var del = '<a href="{{url('admin/optometry/update')}}/'+row.id+'" class="btn btn-xs btn-primary update"> ' +
