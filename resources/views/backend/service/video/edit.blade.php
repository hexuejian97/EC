...
@section('content')
    {{ Form::open(['route' => 'admin.video.edit', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post']) }}

    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">视频空间编辑</h3>
       ...
       <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        {{ Form::hidden('id', $video->id, ['class' => 'form-control', 'maxlength' => '191', 'required' => 'required', 'autofocus' => 'autofocus']) }}
                        {{ Form::text('title', $video->title, ['class' => 'form-control', 'maxlength' => '191', 'required' => 'required', 'autofocus' => 'autofocus']) }}
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        {{ Form::text('intro', $video->intro, ['class' => 'form-control', 'maxlength' => '191', 'required' => 'required', 'autofocus' => 'autofocus']) }}
                    </div><!--col-lg-10-->
                </div>

                <div class="form-group" style="margin-bottom: 10px;">
                    {{ Form::label('picture', '图片', ['class' => 'col-lg-2 control-label']) }}
                    <div class="col-lg-10">
                        <img src="{{$video->picture}}" alt="" style="width:250px;height:100px" id="img">
                        <div id="container1">
                        ...
                        {{ Form::text('picture', $video->picture, ['id' => 'picture','class' => 'form-control', 'maxlength' => '191', 'required' => 'required', 'placeholder' => '' ,'readonly' => 'readonly']) }}
                    </div>
                </div><!--form control-->
                <!--form control-->
            </div><!-- /.box-body -->
