...
@section('content')
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">服务项目列表</h3>

            <div class="box-tools pull-right">
                <a href="{{route('admin.project.add')}}" class="btn btn-success btn-xs">新建服务项目</a>
        ...
        <div class="box-body">
            <div class="table-responsive" >
                ...
                <table  id="table"  data-toggle="table" data-url="{{route('admin.project.data')}}" data-toolbar="#toolbar"
                    ...
                    <tr>
                        ...
                        <th data-field="project_name"  data-align="center">服务项目名称</th>
                        <th data-field="project_type"  data-align="center">服务项目类型</th>
...
@section('after-scripts')
    ...
    <script>
        ...
        function actionFormatter(value, row, index) {
            var ddf = '<a href="{{url('admin/project/info')}}/'+row.id+'" class="btn btn-xs btn-primary "> ' +
                '<i class="fa fa-pencil " data-toggle="tooltip" data-placement="top" ' +
                'data-toggle="tooltip" data-placement="top" title="查看">查看</i></a>&nbsp;&nbsp;';
            var del = '<a href="{{url('admin/project/update')}}/'+row.id+'" class="btn btn-xs btn-primary update"> ' +
